define(["jquery","app/config","underscore","backbone","pinchzoom","jquerypep"], 
function($, DG_Conf, _, Backbone, pinchzoom, jquerypep) {
    ...
    return Backbone.View.extend({
        ...
        // Create New Items
        events: {
            'click #btn_export_grid':'exportGrid'
        },
        ...
        draw_grid: function(show_loading_graphic) {
            ...
            var frame_width = $(document).width()+200;
            ...
            if (grid.get("square")) {
                var width_fix = frame_width+200;
                $(this.el).find(".grid").css({"width": frame_width+"px"});
            } else {
